...
public class RestfulAdapter {
    ...
    private static Map<String, Retrofit> instanceContainer = new HashMap<>();

    // OkHttp Client
    private static OkHttpClient client, unsafeClient;

    private static BaseService Interface;
    ...
    public synchronized static BaseService getInstance() {
        if (Interface == null) {
            ...
            client = new OkHttpClient();
                    //  configureClient(new OkHttpClient().newBuilder()) //인증서 무시
/*
            ...
            Interface = new Retrofit.Builder()
                    ...
                    .build().create(BaseService.class); //인터페이스 연결
        }
        return Interface;
    }
