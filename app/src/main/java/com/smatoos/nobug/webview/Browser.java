...
public class Browser extends WebView {
    ...
    protected void setHeaderProperties() {
        ...
        headers.put(HeaderProperty.AUTH_TOKEN, HeaderProperty.API_KEY);
/*        headers.put(HeaderProperty.VERSION, DeviceInfoUtil.getAppVersion(mContext));
        headers.put(HeaderProperty.CONTENT_TYPE, HeaderProperty.JSON_FORMAT);
        headers.put(HeaderProperty.UUID, DeviceInfoUtil.getDeviceSerialNumber());*/
    }
